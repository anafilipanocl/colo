(function () {
  ...
  var strings = {
    en: {
      ...
      "meta.ogHomeDesc": "A space for platonic, consensual human touch. Now serving Lisbon.",
      ...
      "how.h2": "Three steps, no app, no account.",
      "how.s1": "Reach out",
      ...
      "space.eyebrow": "What this space is",
      "space.h2": "Fully platonic. Spoken, not assumed.",
      ...
      "about.eyebrow": "Meet your cuddler",
      ...
      "about.where": "Where",
      "close.h2": "You don’t need a reason good enough to be held.",
      "close.cta": "Write to me",
      ...
      "faq.h1": "Everything you might be wondering.",
      "faq.intro": "Nothing here is a strange question. If yours isn’t answered, write to me and ask.",
      "faq.grouped": "Grouped so you can find what you need — what this is, how safety works, how we book, and what a session actually feels like.",
      "faq.general": "General",
      "faq.safety": "Safety",
      "faq.booking": "Booking",
      ...
      "faq.a8": "Send me a message through the <a href=\"contact.html\">contact form</a>. Then we’ll have a short, free intro call so we can meet, talk through any questions and get a sense of whether this feels right for both of us. Writing to me does not book a session or commit you to anything.",
      ...
      "faq.stillp": "Write to me. Asking costs nothing, and a message is not a booking.",
      "faq.stillcta": "Contact",
      "contact.eyebrow": "Contact",
      "contact.h1": "Your message comes directly to me.",
    ...
    pt: {
      ...
      "meta.ogHomeDesc": "Um espaço de toque humano platónico e consensual. Agora em Lisboa.",
      ...
      "nav.menu": "Menu",
      "hero.pill": "Agora em Lisboa",
      "hero.h1": "Às vezes, só precisamos de um colo.",
      ...
      "touch.eyebrow": "Uma necessidade humana",
      ...
      "how.h2": "Três passos, sem aplicação, sem conta.",
      "how.s1": "Escreve-me",
      ...
      "space.eyebrow": "O que é este espaço",
      "space.h2": "Totalmente platónico. Falado, não assumido.",
      ...
      "about.where": "Onde",
      "close.h2": "Não precisas de um motivo suficientemente bom para teres colo.",
      "close.cta": "Escreve-me",
      ...
      "faq.h1": "Tudo o que possas estar a perguntar-te.",
      "faq.intro": "Nenhuma pergunta é estranha. Se a tua não estiver aqui, escreve-me e pergunta.",
      "faq.grouped": "Agrupadas para encontrares o que precisas — o que é isto, como funciona a segurança, como marcamos, e o que se sente numa sessão.",
      "faq.general": "Geral",
      ...
      "faq.a8": "Envia-me uma mensagem pelo <a href=\"contact.html\">formulário de contacto</a>. Depois temos uma chamada de apresentação curta e gratuita para nos conhecermos, esclarecer dúvidas e perceber se isto faz sentido para os dois. Escrever-me não marca uma sessão nem te compromete com nada.",
      "faq.q9": "Quanto custa?",
      ...
      "faq.still": "Ainda tens perguntas?",
      "faq.stillp": "Escreve-me. Perguntar não custa nada, e uma mensagem não é uma marcação.",
      "faq.stillcta": "Contacto",
      "contact.eyebrow": "Contacto",
      "contact.h1": "A tua mensagem chega-me a mim.",
