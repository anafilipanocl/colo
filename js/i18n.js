(function () {
  ...
  var strings = {
    ...
    pt: {
      ...
      "touch.p3": "Não precisas de merecer, de explicar, nem de ter um motivo que pareça suficientemente importante.",
      ...
      "about.p1": "Sinto-me naturalmente atraída pelas pequenas coisas que fazem a ligação sentir-se humana. Momentos calmos, conversas com sentido, suavidade, riso, curiosidade, e às vezes simplesmente partilhar o espaço num silêncio confortável.",
      "about.p2": "A minha formação é em psicologia e trabalho terapêutico, e essa experiência molda a forma como cuido do espaço: com atenção, calor e respeito pelo ritmo de cada pessoa. Trago uma perspectiva com consciência do trauma e procuro criar um espaço inclusivo de diferentes corpos, identidades, relações e formas de nos relacionarmos.",
      ...
      "faq.a1": "O cuddling profissional é um espaço de toque humano platónico e consensual. Podemos dar colo, dar as mãos, sentar-nos ao pé, conversar, rir ou simplesmente descansar juntos. Não há uma forma certa para uma sessão. Descobrimos juntos o que se sente confortável.",
      "faq.q2": "É sexual?",
      ...
      "faq.a15": "De maneira nenhuma. Podes saber exactamente que tipo de toque te faz bem, ou podes não ter ideia nenhuma. Descobrimos juntos.",
      "faq.q16": "O que visto?",
