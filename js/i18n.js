(function () {
  ...
  var strings = {
    en: {
      ...
      "how.h2": "How it works",
      "how.s1": "Reach out",
      "how.s1p": "Send me a message through the contact form below, whenever feels right. You can tell me as much or as little as you like.",
      "how.s2": "We talk",
      ...
      "how.s3": "We meet",
      "how.s3p": "We start by checking in, then move at your pace, talking, sitting close, cuddling, or simply resting in silence. We can find out together.",
      ...
      "about.approachv": "Trauma-informed · LGBTQIA+ affirming · disability-inclusive",
      "about.languages": "Languages",
      "about.languagesv": "Portuguese · English",
      "about.where": "Where",
      "about.wherev": "Lisbon, Portugal",
      "brand.meta": "Cuddling · Lisbon",
      "foot.copy": "© 2026 Colo · Lisbon",
      "foot.blurb": "Platonic, professional cuddling for adults.",
      "foot.site": "Site",
      "foot.where": "Where",
      "foot.serving": "Currently serving Lisbon, Portugal",
      "foot.legal": "Strictly platonic · Adults only",
      "foot.photos": "Photos by <a href=\"https://www.inesdust.com/\" target=\"_blank\" rel=\"noopener noreferrer\">Inês Dust</a>",
      "faq.h1": "Questions",
      ...
      "faq.q7": "Is it safe?",
      "faq.a7": "<p>Feeling safe can mean different things to different people, so I don’t want to assume what it looks like for you. My aim is to create that space together.</p><p>We talk beforehand, check in before any touch, and keep communicating as we go. Boundaries are spoken rather than assumed, and you can say yes, no, not yet, something different, or change your mind at any time.</p><p>We both stay fully clothed, and there is nothing you have to do or perform while you’re here.</p>",
      "faq.q8": "How do I book a session?",
      "faq.a8": "<p>Send me a message through the <a href=\"#contact\">contact form</a>. Then we’ll have a short, free intro call so we can meet, talk through any questions, and get a sense of whether this feels right for both of us.</p><p>If it does, we’ll agree on a time and place. Your session is confirmed once the payment has been received.</p>",
      "faq.q9": "How much does it cost?",
      "faq.a9": "Sessions are €90 per hour. The intro call is always free.",
      "faq.q10": "How do I pay?",
      "faq.a10": "The payment can be done by Revolut, MB Way or bank transfer. The details are sent after we’ve spoken and agreed on a time.",
      ...
      "faq.q12": "Is professional cuddling accessible for people with disability?",
      "faq.a12": "<p>I want COLO to be as accessible as possible. If you have any access needs, you’re welcome to tell me what would help you feel comfortable — whether that’s around positioning, movement, communication, sensory needs, taking breaks, presence of a personal assistant, mobility aids or something else.</p><p>I won’t assume what you need or what your body can do. We can talk it through together and adapt the session where possible. If there’s something about the space or setup that I can’t accommodate, I’ll always be upfront about it.</p>",
      ...
      "contact.h1": "Contact",
      "contact.lede": "Tell me as much or as little as you want. We’ll take it from there, with a free intro call before the first session.",
    ...
    pt: {
      ...
      "touch.p1": "Talvez vivas sozinho. Talvez estejas longe das pessoas de quem gostas. Talvez estejas a passar por algo difícil. Talvez tenhas passado muito tempo a dar colo a toda a gente.",
      "touch.p2": "Ou talvez não se passe mesmo nada de errado. Só queres partilhar o conforto do toque humano.",
      ...
      "how.s1": "Escreve-me",
      "how.s1p": "Envia-me uma mensagem pelo formulário de contacto abaixo, quando quiseres. Podes partilhar comigo tanto ou tão pouco quanto quiseres.",
      "how.s2": "Falamos",
      ...
      "how.s3p": "Começamos por perceber como estás e avançamos ao teu ritmo: a conversar, olhar um para o outro, cuddling, ou simplesmente a partilhar silêncio. Descobrimos juntos.",
      ...
      "space.p2": "Somos dois seres humanos a partilhar espaço e toque, com limites que comunicamos, e não apenas assumimos.",
      ...
      "about.alt": "A Ana, a sorrir numa floresta, refletida num espelho redondo sobre musgo.",
      "about.h2": "Olá, sou a Ana.",
      "about.p1": "Sinto-me naturalmente atraída pelas pequenas coisas que tornam a ligação mais humana. Momentos calmos, conversas profundas, sensibilidade, riso, curiosidade, e às vezes simplesmente partilhar espaço com alguém num silêncio confortável.",
      "about.p2": "A minha formação é em psicologia e trabalho terapêutico, e essa experiência influencia a forma como estou com cada pessoa: com atenção, presença e respeito pelo ritmo de cada um. Trabalho a partir de uma perspetiva informada pelo trauma e procuro criar um espaço onde diferentes corpos, identidades, relações e formas de estar possam ser recebidos com respeito.",
      "about.p3": "Acima de tudo, espero oferecer presença, proximidade e um pouco de humanidade - um espaço onde possas simplesmente estar como és.",
      "about.p4": "Fora daqui, é provável que me encontres à mesa com amigos, algures na natureza, a fazer alguma coisa com as mãos ou simplesmente em movimento.",
      "about.background": "Percurso",
      "about.backgroundv": "Psicologia e trabalho terapêutico",
      "about.approach": "Abordagem",
      "about.approachv": "Informada pelo trauma · afirmativa LGBTQIA+ · inclusiva da diversidade funcional",
      "about.languages": "Línguas",
      "about.languagesv": "Português · English",
      "about.where": "Onde",
      "about.wherev": "Lisboa, Portugal",
      "brand.meta": "Cuddling · Lisboa",
      "foot.copy": "© 2026 Colo · Lisboa",
      "foot.blurb": "Cuddling profissional e platónico para adultos.",
      "foot.site": "Site",
      "foot.where": "Onde",
      "foot.serving": "Neste momento em Lisboa, Portugal",
      "foot.legal": "Estritamente platónico · Só adultos",
      "foot.photos": "Fotografias de <a href=\"https://www.inesdust.com/\" target=\"_blank\" rel=\"noopener noreferrer\">Inês Dust</a>",
      "faq.h1": "Perguntas",
      ...
      "faq.a1": "O cuddling profissional é um espaço de toque humano platónico e consensual. Podemos dar cuddles, dar as mãos, sentar-nos ao pé, conversar, rir ou simplesmente descansar juntos. Não há uma forma certa para uma sessão. Descobrimos juntos o que nos faz sentir confortáveis.",
      "faq.q2": "É sexual?",
      "faq.a2": "Não. O cuddling profissional é totalmente platónico e ambos permanecemos vestidos durante a sessão. O toque sexual não faz parte deste espaço. São os limites claros que nos permitem relaxar em proximidade, sem ter de pensar no que vem a seguir.",
      "faq.q3": "Isto é terapia?",
      "faq.a3": "Não. Embora a minha formação seja em psicologia e trabalho terapêutico, as sessões de cuddling não são terapia. A minha formação molda a forma como cuido deste espaço, com particular atenção à segurança, ao consentimento e a uma abordagem informada pelo trauma, procurando criar um lugar onde diferentes corpos, identidades e formas de ser se sintam acolhidos.",
      ...
      "faq.a6": "As sessões acontecem num espaço calmo e privado em Lisboa. Partilho a morada exata depois de falarmos e marcarmos uma sessão.",
      "faq.q7": "É seguro?",
      "faq.a7": "<p>Sentir-se em segurança pode significar coisas diferentes para pessoas diferentes, por isso não quero assumir o que isso parece para ti. O meu objetivo é criarmos esse espaço juntos.</p><p>Falamos antes, vemos como estamos antes de qualquer toque e vamos comunicando ao longo do caminho. Os limites são falados, não assumidos, e podes dizer sim, não, ainda não, outra coisa, ou mudar de ideias a qualquer momento.</p><p>Ambos ficamos vestidos, e não há nada que tenhas de fazer ou representar enquanto estás aqui.</p>",
      "faq.q8": "Como marco uma sessão?",
      "faq.a8": "<p>Envia-me uma mensagem pelo <a href=\"#contact\">formulário de contacto</a>. Depois temos uma chamada de apresentação curta e gratuita para nos conhecermos, esclarecer dúvidas e perceber se isto faz sentido para os dois.</p><p>Se fizer, combinamos um horário e um local. A sessão fica confirmada assim que o pagamento for recebido.</p>",
      "faq.q9": "Quanto custa?",
      "faq.a9": "As sessões são 90 € por hora. A chamada de apresentação é sempre gratuita.",
      "faq.q10": "Como pago?",
      "faq.a10": "O pagamento pode ser feito por Revolut, MB Way ou transferência bancária. Os dados são enviados depois de falarmos e acordarmos um horário.",
      "faq.q11": "E se precisar de cancelar?",
      "faq.a11": "Se surgir algum imprevisto, avisa-me assim que puderes. Em cancelamentos feitos com menos de 24 horas de antecedência, o valor da sessão é cobrado na totalidade.",
      "faq.q12": "O cuddling profissional é acessível a pessoas com deficiência?",
      "faq.a12": "<p>Quero que o COLO seja tão acessível quanto possível. Se tiveres alguma necessidade de acessibilidade, podes dizer-me o que te ajudaria a sentires-te confortável — seja em relação ao posicionamento, movimento, comunicação, necessidades sensoriais, pausas, presença de um assistente pessoal, produtos de apoio ou qualquer outra coisa.</p><p>Não vou partir do princípio de que sei aquilo de que precisas ou aquilo que o teu corpo consegue fazer. Podemos conversar sobre isso e adaptar a sessão sempre que possível. Se houver alguma coisa relacionada com o espaço ou com a forma como a sessão está organizada que eu não consiga acomodar, vou ser sempre transparente contigo.</p>",
      "faq.q14": "E se me sentir nervoso ou sem jeito?",
      "faq.a14": "Não faz mal. Partilhar toque com alguém novo pode fazer-te sentir vulnerável, pouco à vontade, ou simplesmente um pouco estranho, no início. Podemos ir com calma. Estar sem jeito também é bem-vindo.",
      "faq.q15": "Preciso de saber o que quero?",
      "faq.a15": "De maneira nenhuma. Podes saber exatamente que tipo de toque te faz bem, ou podes não ter ideia nenhuma. Descobrimos juntos.",
      "faq.q16": "O que visto?",
      "faq.a16": "Algo limpo, confortável e que te deixe à vontade. No fundo, aquilo que vestirias para te aninhares no sofá. Durante toda a sessão, ambos permanecemos vestidos.",
      ...
      "contact.h1": "Contacto",
      "contact.lede": "Diz-me tanto ou tão pouco quanto quiseres. Seguimos daí, com uma chamada de apresentação gratuita antes da primeira sessão.",
      ...
      "form.error": "Algo correu mal ao enviar o formulário. Tenta outra vez, ou escreve-me diretamente.",
    },
  };
