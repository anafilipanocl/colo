(function () {
  ...
  var strings = {
    ...
    pt: {
      ...
      "touch.p2": "Ou talvez não se passe mesmo nada de errado. Só queres partilhar a alegria do toque humano.",
      ...
      "how.s1": "Escreve-me",
      "how.s1p": "Envia-me uma mensagem pelo formulário de contacto abaixo, quando quiseres. Podes contar-me tanto quanto quiseres, ou quase nada.",
      "how.s2": "Falamos",
      ...
      "how.s3p": "Começamos por ver como estás e avançamos ao teu ritmo, a conversar, sentados ao pé, a dar colo, ou simplesmente em silêncio. Descobrimos juntos.",
      ...
      "about.p1": "Sinto-me naturalmente atraída pelas pequenas coisas que tornam a ligação mais humana. Momentos calmos, conversas com sentido, suavidade, riso, curiosidade, e às vezes simplesmente partilhar o espaço num silêncio confortável.",
      "about.p2": "A minha formação é em psicologia e trabalho terapêutico, e essa experiência molda a forma como cuido do espaço: com atenção, calor e respeito pelo ritmo de cada pessoa. Trago uma perspetiva com consciência do trauma e procuro criar um espaço inclusivo de diferentes corpos, identidades, relações e formas de se relacionar.",
      "about.p3": "Acima de tudo, espero trazer calor, presença e um pedacinho de ligação humana, um sítio onde podes simplesmente chegar como és.",
      "about.p4": "Fora deste espaço, é bem possível que me encontres a partilhar uma refeição com amigos, algures na natureza, a fazer alguma coisa com as mãos, ou em movimento.",
      "about.background": "Percurso",
      "about.backgroundv": "Psicologia e trabalho terapêutico",
      "about.approach": "Abordagem",
      "about.approachv": "Com consciência do trauma · inclusiva",
      "about.languages": "Línguas",
      "about.where": "Onde",
      "foot.blurb": "Cuddling profissional e platónico para adultos. Uma profissional, por marcação, num espaço privado em Lisboa.",
      "foot.site": "Site",
      "foot.where": "Onde",
      ...
      "faq.a1": "O cuddling profissional é um espaço de toque humano platónico e consensual. Podemos dar colo, dar as mãos, sentar-nos ao pé, conversar, rir ou simplesmente descansar juntos. Não há uma forma certa para uma sessão. Descobrimos juntos o que nos faz sentir confortáveis.",
      "faq.q2": "É sexual?",
      "faq.a2": "Não. O cuddling profissional é totalmente platónico e ambos permanecemos vestidos durante a sessão. O toque sexual não faz parte deste espaço. São os limites claros que nos permitem relaxar na proximidade sem ficarmos a pensar para onde isto vai.",
      ...
      "faq.a13": "Começamos por perguntar como te sentes e falar do que é confortável nesse dia. A partir daí, vamos com calma. Podemos conversar, sentar-nos ao pé, dar colo, rir, estar em silêncio ou simplesmente descansar juntos. Não há lista de tarefas nem nada que tenhas de fazer. No fim, há sempre um tempo para integrar.",
      ...
      "contact.h1": "Contacto",
      "contact.lede": "Diz-me tanto quanto quiseres, ou quase nada. Seguimos daí, normalmente com uma chamada de apresentação gratuita antes de qualquer sessão.",
